...
const pageTraffic = [
    { id: 1, source: 'Direct', sourceType: 'Direct', rank: 2, trafficShare: 51, change: 2.45, sourceIcon: faGlobeEurope, sourceIconColor: 'gray' },
    { id: 2, source: 'Google Search', sourceType: 'Search / Organic', rank: 2, trafficShare: 18, change: 17.67, sourceIcon: faGoogle, sourceIconColor: 'info' },
    { id: 3, source: 'youtube.com', sourceType: 'Social', category: 'Arts and Entertainment', rank: 2, trafficShare: 27, change: 17.67, sourceIcon: faYoutube, sourceIconColor: 'danger' },
    ...
    { id: 5, source: 'twitter.com', sourceType: 'Social', category: 'Social Networks', rank: 4, trafficShare: 4, change: 17.67, sourceIcon: faTwitter, sourceIconColor: 'info' }
]

const pageRanking = [
    { id: 1, country: 'United States', countryImage: USAFlag, overallRank: 76, overallRankChange: -5, travelRank: 3, travelRankChange: 1, widgetsRank: 32, widgetsRankChange: 3 },
    { id: 2, country: 'Canada', countryImage: CanadaFlag, overallRank: 106, overallRankChange: 17, travelRank: 4, travelRankChange: 1, widgetsRank: 30, widgetsRankChange: 3 },
    { id: 4, country: 'France', countryImage: FranceFlag, overallRank: 112, overallRankChange: 10, travelRank: 5, travelRankChange: 1, widgetsRank: 34, widgetsRankChange: 7 },
