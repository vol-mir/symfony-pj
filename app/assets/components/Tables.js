...
const ValueChange = ({ value, suffix }) => {
    ...
    return (
        value ? <span className={valueTxtColor}><FontAwesomeIcon icon={valueIcon} /><span className="fw-bold ms-1">{Math.abs(value)}{suffix}</span></span> : '--'
    )
}
...
export const PageTrafficTable = () => {
    ...
    TableRow.propTypes = {
        ...
        sourceIconColor: PropTypes.string,
        sourceType: PropTypes.string,
        category: PropTypes.string,
        rank: PropTypes.number,
        trafficShare: PropTypes.number,
...
export const RankingTable = () => {
    ...
    TableRow.propTypes = {
        ...
        overallRankChange: PropTypes.number,
        travelRank: PropTypes.number,
        travelRankChange: PropTypes.number,
        widgetsRank: PropTypes.number,
        widgetsRankChange: PropTypes.number
    }
...
export const TransactionsTable = () => {
    ...
    const TableRow = (props) => {
        ...
        return (
            <tr>
                <td>
                    <Card.Link as={Link} to={RoutesApp.About.path} className="fw-normal">
                        {invoiceNumber}
                    </Card.Link>
                </td>
                <td>
